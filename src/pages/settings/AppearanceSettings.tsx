            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="mr-2 text-gray-700">{option.icon}</div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {fontSizeOptions.map((option) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span className={`${option.style} font-medium`}>
                  {option.name}
                </span>
                {fontSize === option.id && (
                  <motion.div
        ...
        >
          <div className="space-y-4">
            ...
            >
              ...
              `}
              >
                This is a preview of how your interface will look with the
                selected settings. The text size, spacing, and colors will
